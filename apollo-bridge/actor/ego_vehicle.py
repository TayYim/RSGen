...
class EgoVehicle:
    ...
    def _update_linear_velocity(self):
        self.linear_velocity.x = self.ego_vehicle.get_velocity().x
        self.linear_velocity.y = -self.ego_vehicle.get_velocity().y
        self.linear_velocity.z = self.ego_vehicle.get_velocity().z
