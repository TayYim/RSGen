...
from utils.transforms import DEVIATION_X, DEVIATION_Y
...
class Routing(object):
    ...
    def _generate_waypoint(self, start_location, target_location, routing_request):
        ...
        start_location.x = start_location.x + DEVIATION_X
        start_location.y = start_location.y * -1 + DEVIATION_Y
        target_location.x = target_location.x + DEVIATION_X
        target_location.y = target_location.y * -1 + DEVIATION_Y
