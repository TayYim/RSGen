...
# DEVIATION_X = 166021.44308054057
# DEVIATION_Y = 10000000.000
...
def carla_location_to_cyber_point3d(carla_location):
    ...
    cyber_translation.x = carla_location.x + DEVIATION_X
    cyber_translation.y = -carla_location.y + DEVIATION_Y
    cyber_translation.z = carla_location.z
...
def carla_location_to_cyber_point(carla_location):
    ...
    cyber_point.x = carla_location.x + DEVIATION_X
    cyber_point.y = -carla_location.y + DEVIATION_Y
...
def cyber_point_to_carla_location(cyber_point):
    return carla.Location(
        cyber_point.x - DEVIATION_X, (cyber_point.y - DEVIATION_Y) * -1, cyber_point.z
    )
