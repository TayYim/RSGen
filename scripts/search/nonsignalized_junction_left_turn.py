...
class NonSignalizedJunctionLeftTurn(BasicTrafficEnv):
...
if __name__ == "__main__":
    ...
    scenarioInstance = NonSignalizedJunctionLeftTurn(
        env_name="NonSignalizedJunctionLeftTurn-v0",
        render=False,
        model_path=Path(
            "data/models/MAF_crossroads_ego_left_turn_bv_opposite_best.pth"
        ),
        natural_data_path=Path(
            "data/datasets/crossroads_ego_left_turn_bv_opposite.json"
        ),
