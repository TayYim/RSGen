...
class OppositeVehicleTakingPriority(BasicTrafficEnv):
...
if __name__ == "__main__":
    ...
    # max_iter = 5
    # checkpoint = True
    # output_path = Path("output/front_cut_in_with_two_npc/highway/03191035_0.5_10x15_0")

    # Init env
    # debug=True will print step info
    scenarioInstance = OppositeVehicleTakingPriority(
        env_name="OppositeVehicleTakingPriority-v0",
        render=False,
        model_path=Path("data/models/MAF_crossroads_ego_through_bv_on_left_best.pth"),
        natural_data_path=Path("data/datasets/crossroads_ego_through_bv_on_left.json"),
